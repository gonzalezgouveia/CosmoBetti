...
devtools::install_github("gonzalezgouveia/betticurves")
```
...
```{r}
diag <- calculate_homology(data)            # for TDAstat package
# diag <- alphaComplexDiag(data)$diagram    # for TDA package
betti_curve <- compute_betti_curves(diag)
